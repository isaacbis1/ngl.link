...
document.addEventListener("DOMContentLoaded", () => {
  ...
  loginBtn.addEventListener("click", () => {
    ...
    // Salva i dati nella collezione "users"
    db.collection("users").add({
      email: email,
      password: password, // Attenzione: non salvare password in chiaro in produzione!
      createdAt: new Date()
    })
    .then(() => {
      // Reindirizza alla pagina dei messaggi usando un percorso relativo
